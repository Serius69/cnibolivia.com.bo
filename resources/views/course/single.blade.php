                   ...
                   <!-- BLOG START -->
                    <div class="blog-post date-style-2 blog-lg">
                        <div class="wt-post-media wt-img-effect zoom-slow">
                            <a href="curso.show">                                
                                <img src="{{ url('img/curso/'.$course->path) }}" width="1" height="1"></a>
                        </div>
                        <div class="wt-post-info  bg-white p-t30">
                            <div class="wt-post-meta ">
                                <ul>
                                    ...
                                    {{date("d", strtotime($course->date_publication))}}, {{date("Y", strtotime($course->date_publication))}}
                                </li>
                                </ul>
                            </div>
                            ...
                            <div class="wt-post-title ">
                                <a href=" {{$course->url}}">
                                    <h4 class="post-title">Descarga información adjunta en el siguiente enlace >></h4>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="theiaStickySidebar" style="padding-top: 0px; padding-bottom: 1px; position: static; transform: none; top: 0px; left: 1156.5px;"><aside class="side-bar">
                           ...
                           <div class="widget recent-posts-entry p-a20">
                                <div class="text-left m-b30">
                                    <h3 class="widget-title">   Cursos Recientes</h3>
                                </div>
                                        ...
                                        <div class="widget-post clearfix">
                                            ...
                                            <div class="wt-post-info">
                                                <div class="wt-post-header">
                                                    <h6 class="post-title"> <a href="{{ route('curso.show',$course->id) }}">{{$course->name}}</a></h6>
                                                </div>
                                                <div class="wt-post-meta">
                                                    <ul>
                                                        <li class="post-author">{{ $course->date_publication }}</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>

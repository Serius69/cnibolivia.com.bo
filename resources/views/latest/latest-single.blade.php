                    ...
                    <div class="blog-post date-style-2 blog-lg">
                        <div class="wt-post-media wt-img-effect zoom-slow">
                            <a href="latests.show">
                                ...
                                <img src="{{ url('img/noticias/'.$latest->path) }}" width="1" height="1"></a>
                        </div>
                        <div class="wt-post-info  bg-white p-t30">
                            ...
                            <div class="wt-post-title ">
                                <h2 class="post-title">{{$latest->title}}</h2>
                            </div>
                            <div class="wt-post-text">
                                    <p style="text-align: justify" >{{ $latest->description }}</p>
                            </div>
                            <div class="wt-post-title ">
                                <a href="">
                                </a>
                                        ...
                                        <div class="widget-post clearfix">
                                            ...
                                            <div class="wt-post-info">
                                                <div class="wt-post-header">
                                                    <h6 class="post-title"> <a href="{{ route('noticia.show',$latest->id) }}">{{$latest->title}}</a></h6>
                                                </div>
                                                <div class="wt-post-meta">
                                                    <ul>
                                                        <li class="post-author">{{ $latest->date_publication }}</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
